...
public class JDBC_Format {
    private static String SQL_INSERT_ONE = "            " +
            "INSERT INTO dc_format                      " +
            "   (   id                                  " +
            "      ,sName                               " +
            "   )                                       " +
            " VALUES                                    " +
            "   (?, ?)                                  ";
    //----------------------------------------------------------------------------------
    public JDBC_Response insert(List<DC_Format> lObject, Connection con) {
    ...
    public JDBC_Response truncateAll(Connection con) {
        ...
        try {
            ...
            statement.executeUpdate("TRUNCATE TABLE dc_format");
