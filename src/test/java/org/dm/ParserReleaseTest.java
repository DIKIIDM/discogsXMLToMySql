...
public class ParserReleaseTest {
    ...
    public void parseReleases() throws Exception {
        ...
        List<DC_Release> lReleases = (List<DC_Release>)parserRelease.parse(sXML_release);
        ...
        assertTrue(lReleases.get(0).lLabel.size() == 2);
        assertTrue(lReleases.get(1).lArtist.size() == 5);
        assertTrue(lReleases.get(1).lExtraArtist.size() == 0);
        assertTrue(lReleases.get(1).lStyle.size() == 1);
        assertTrue(lReleases.get(1).lGenre.size() == 1);
        assertTrue(lReleases.get(1).lTrack.size() == 4);
        assertTrue(lReleases.get(1).lLabel.size() == 1);
        assertTrue(lReleases.get(2).lArtist.size() == 1);
        assertTrue(lReleases.get(2).lExtraArtist.size() == 5);
        assertTrue(lReleases.get(2).lStyle.size() == 2);
        assertTrue(lReleases.get(2).lGenre.size() == 1);
        assertTrue(lReleases.get(2).lTrack.size() == 4);
        assertTrue(lReleases.get(2).lLabel.size() == 1);
        ...
        for (DC_Release release: lReleases) {
            ...
            for (DC_ReleaseLabel label: release.lLabel) {
